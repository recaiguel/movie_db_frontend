...
if (isset($_POST['submit_regie'])) {
    ...
    $sql = "INSERT INTO regie (vorname, nachname, geburtsdatum, geschlecht, nationalität)
    ...
    $stmt->execute([
        ...
        header("Location: admin-regie.php?saved=true");
        exit;
...
?>
    ...
    <?php 
        ...
        <div>
            Regisseur erfolgreich gespeichert!
        </div>
    <?php endif; ?>

    <h2>Regisseur hinzufügen</h2>
